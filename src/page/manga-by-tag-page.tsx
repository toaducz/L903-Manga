...
export default function MangaByTagPage({ id, publicationDemographic, pagination }: MangaByTagPageProps) {
  ...
  return (
    <div className='min-h-screen flex flex-col items-center justify-center p-4'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 sm:gap-5 gap-1 p-3 w-full [grid-template-columns:repeat(auto-fill,minmax(120px,1fr))] sm:[grid-template-columns:repeat(auto-fill,minmax(300px,1fr))]'>
